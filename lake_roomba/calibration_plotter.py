...
def main():
    ...
    original_df = load_clean_csv(os.path.join(script_dir, "mag_data.csv")) # helper function to load and clean the data, makes sure only lines with x,y,z values are present
